...
モジュール構成:
  ...
  pamc104_204_wrapper  - PAMC-104/204 send_command ラッパークラス（PAMC104_204）
...
起動方法:
  ...
  python -m demo --mode pamc104_204     # PAMC-104/204 send_command モード
  python demo/main.py --mode pamc104_204
"""
